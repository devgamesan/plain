...
| --- | --- |
| Image preview | `chafa` for symbol output; compatible Kitty-graphics terminals can use the built-in protocol |
...
- Text, images (chafa; optional Kitty graphics protocol on compatible terminals), PDF text, and Office text previews
